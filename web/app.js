...
function renderHistoricalComparison(){
  ...
  svg.setAttribute('viewBox','0 0 900 315');svg.setAttribute('role','img');svg.setAttribute('aria-label','Mean Brier forecast error on identical historical cases, lower is better');svg.style.cssText='width:100%;min-width:660px;display:block;background:#19161b;font:15px Arial, sans-serif';
